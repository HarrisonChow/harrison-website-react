          ...
          <div className="col-sm-6 col-md-2">
            <div className="thumbnail">
              <a href="https://harrisonchow.github.io/tictactoe/index.html" className="thumbnail">
                <img src="images/portfolios/projects/tictactoe.jpg"/>
              </a>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="thumbnail">
              <a href="http://ga-project-3.herokuapp.com/" className="thumbnail">
                <img src="images/portfolios/projects/toptopics.jpg"/>
              </a>
              <div className="caption">
                <h3>Top topics</h3>
                <p>Group project</p>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="thumbnail">
              <a href="#" className="thumbnail">
                <img src="images/portfolios/projects/ewall.jp"/>
              </a>
              <div className="caption">
                <h3>E wall </h3>
                <p>Final project</p>
          ...
          <div className="col-sm-6 col-md-2">
            <div className="thumbnail">
              <a href="https://coffee-buddy.herokuapp.com/" className="thumbnail">
                <img src="images/portfolios/projects/coffee-buddy.jpg"/>
              </a>
              <div className="caption">
                <h4>Coffee Buddy</h4>
